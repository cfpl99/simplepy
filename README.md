[中文](https://github.com/cnzbpy/simplepy)|[English](https://github.com/cnzbpy/simplepy/wiki/English-introduction)

* 我是python的爱好者，喜欢收集python编写的程序和代码。下面是收集和编写的代码，喜欢这个或者觉得有用的还请多多支持我。

* 网盘：https://www.lanzoux.com/b01hlwsdi 访问密码:W4mT 解压密码：52pojie

* [CPlayer：基于FFPyPlayer和python-vlc的全能媒体播放器。](https://github.com/cnzbpy/simplepy/blob/master/CPlayer)

* [ffmpeg常用功能集合：简单的把ffmpeg一些常用功能集合到python调用,如转换、变速、替换视频中的音频、合并相同格式的多个视频或相同格式的多个音频、分离、截取。](https://github.com/cnzbpy/simplepy/blob/master/ffmpeg常用功能集合)
...
* [pip常用功能集合：包含升级pip、查看已安装包列表、在线搜索软件包、查看可升级软件包、在线安装软件包、从本地安装软件包、从依赖包列表在线安装、卸载软件包、升级软件包、导出已安装软件包列表。](https://github.com/cnzbpy/simplepy/blob/master/pip常用功能集合.bat)

* [wifi密码查看和删除：查看wifi密码或者删除所有保存的wifi密码](https://github.com/cnzbpy/simplepy/blob/master/wifi密码查看和删除.bat)

* [You-Get常用功能集合：简单的把You-Get一些常用功能集合到python调用,如查看格式、在线播放、下载、获取真实地址。](https://github.com/cnzbpy/simplepy/blob/master/You-Get常用功能集合.py)
...
![微信打赏.png](https://i.loli.net/2020/11/21/yh1GrA8JbQ7nVEw.png)	![支付宝打赏.jpg](https://i.loli.net/2020/11/21/WZzIg65bhwvYjmR.jpg)
